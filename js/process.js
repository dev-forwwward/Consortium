...
// Same interaction pattern as faqs.js (see that file's source link), scoped to
// [pb-component="accordion-process"] instead of "accordion-faqs".

export function process() {

  class PBAccordionProcess {
    constructor() {
    ...
    cleanupInitialState() {
      document.querySelectorAll('[pb-component="accordion-process"]').forEach(accordion => {
